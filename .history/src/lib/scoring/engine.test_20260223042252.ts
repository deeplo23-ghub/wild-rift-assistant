...
describe("Scoring Engine Core", () => {
  ...
  it("handles a complex populated draft correctly (boosts component coverage)", () => {
    ...
    draft.ally[Role.Bottom] = { ...draft.ally[Role.Bottom], championId: "lucian" };
    draft.enemy[Role.Bottom] = { ...draft.enemy[Role.Bottom], championId: "caitlyn" };
    ...
    const lucian: Champion = { ...dummyChamp, id: "lucian", roles: [Role.Bottom], tags: [ChampionTag.Burst, ChampionTag.Marksman] };
    const caitlyn: Champion = { ...dummyChamp, id: "caitlyn", roles: [Role.Bottom], tags: [ChampionTag.Poke, ChampionTag.Marksman] };
