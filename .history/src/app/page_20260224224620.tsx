...
export default function DraftPage() {
  ...
  return (
    <main 
      className="h-screen bg-transparent text-zinc-300 font-sans selection:bg-blue-500/30 overflow-hidden flex flex-col"
      onClick={() => {
    ...
    >
      ...
      {/* Main Studio Layout */}
      <div 
        className="flex-1 min-h-0 overflow-hidden p-6 grid grid-cols-[340px_1fr_340px] gap-6 max-w-[1920px] mx-auto w-full"
        onClick={() => {
           const state = useDraftStore.getState();
           state.setFocusedSlot(state.focusedSide, null);
        }}
