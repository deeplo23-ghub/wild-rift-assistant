...
export default function DraftPage() {
  ...
  useEffect(() => {
    // Keep loading screen for the duration of the logo drawing animation (~3.5s)
  ...
  if (loadingChamps || loadingMatrix || isAnimating) {
    return (
      <div className="flex h-screen w-full items-center justify-center bg-zinc-950 text-white font-sans overflow-hidden">
        <div className="flex flex-col items-center gap-12 relative">
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="flex items-center gap-3">
              ...
              <p className="text-[10px] font-black capitalize tracking-[0.5em] text-blue-500/50">Initialising Core</p>
            </div>
  ...
  return (
    <main 
      ...
      onClick={() => {
        // Just clear focus, don't change mode
