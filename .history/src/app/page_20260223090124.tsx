...
export default function DraftPage() {
  ...
  return (
    <main 
      className="min-h-screen bg-zinc-950 text-zinc-300 font-sans selection:bg-blue-500/30 overflow-hidden flex flex-col"
      onClick={() => useDraftStore.getState().setFocusedSlot(TeamSide.Ally, null)}
    >
      {/* Mini Header */}
      <header className="h-14 border-b border-white/5 flex items-center justify-between px-6 bg-black/20 backdrop-blur-md">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="h-5 w-5 bg-blue-600 rounded-sm rotate-45 flex items-center justify-center">
