          ...
          >
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-3">
                <Logo className="w-12 h-8" active />
              ...
              <div className="flex items-center gap-3">
                <div
                  ...
                  className={cn(
                    "flex items-center gap-2 px-3 py-1 rounded-full border transition-all duration-300 cursor-pointer hover:bg-white/10",
                    isBanMode
                ...
                >
                  ...
                  />
                  <Label
                    className="text-[10px] font-bold capitalize tracking-wider cursor-pointer pointer-events-none"
                  >
                    Ban Mode
                  </Label>
                  <Switch
                    checked={isBanMode}
                    className="scale-75 data-[state=checked]:bg-red-500 pointer-events-none"
                  />
                </div>
              </div>
            </div>
