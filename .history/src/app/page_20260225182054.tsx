...
export default function DraftPage() {
  ...
  useEffect(() => {
    if (isDraftComplete) {
      ...
      const timer = setTimeout(() => setAnalysisReady(true), 4000);
                ...
                {isDraftComplete && !analysisReady ? (
                  ...
                  >
                    ...
                    <div className="mt-2">
                      ...
                      `}} />
                      <svg className="loading-text-svg w-[260px] h-[28px] opacity-80" xmlns="http://www.w3.org/2000/svg" viewBox="0 13.85 443.35 45.35">
                        <g>
