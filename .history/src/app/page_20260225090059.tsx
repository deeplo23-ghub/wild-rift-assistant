...
export default function DraftPage() {
  ...
  useEffect(() => {
    // Keep loading screen for the duration of the logo drawing animation (~4.5s)
          ...
          <div className="flex flex-col items-center gap-12 relative">
            ...
            >
              ...
              <div className="flex justify-between w-full px-0.5">
                <span className="text-[9px] font-black tracking-[0.2em] text-blue-500/60 uppercase">System Link</span>
