...
import { Loader2, RotateCcw, Cpu } from "lucide-react";
...
export default function DraftPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-zinc-950 text-zinc-100 selection:bg-blue-500/30 overflow-hidden">
      ...
      <main className="flex-1 overflow-hidden grid grid-cols-1 lg:grid-cols-[280px_1fr_280px] xl:grid-cols-[320px_1fr_320px] 2xl:grid-cols-[360px_1fr_360px]">
        ...
        {/* Right Aspect: Enemy Team */}
        <section className="hidden lg:flex flex-col border-l border-zinc-900 p-2 overflow-hidden">
          <EnemyPanel />
        </section>
      </main>
