...
export function Logo({ className, delay = 0 }: LogoProps) {
  ...
  const draw = {
    ...
    visible: (i: number) => {
      const wait = delay + i * 0.05;
      return {
        pathLength: 1,
        opacity: 1,
        transition: {
          pathLength: { delay: wait, type: "spring", duration: 1.5, bounce: 0 },
          opacity: { delay: wait, duration: 0.01 }
        }
      };
    }
  };
      ...
      >
        <g transform="translate(-126,-121)">
          ...
          <motion.polygon 
            ...
            points="624.6 205.1 634.4 205.1 634.4 191.8 644.4 191.8 646.9 183.1 634.4 183.1 634.4 174.7 648.6 174.7 648.6 165.8 624.6 165.8" 
          />
          <motion.path 
            custom={3}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
            ...
            d="m599.9 206.3c11.3 0 20.6-9.2 20.6-20.4 0-11.3-9.2-20.4-20.6-20.4-11.3 0-20.6 9.2-20.6 20.4 0.1 11.2 9.3 20.4 20.6 20.4zm0-31.4c6.1 0 11 4.9 11 11 0 6-4.9 11-11 11s-11-4.9-11-11 5-11 11-11z" 
          />
          <motion.polygon 
            custom={4}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
            ...
            points="416.2 244.6 420.4 253.3 420.4 332 438.7 332 438.7 274.5 479.8 332 498.9 332 498.9 244.6 480.6 244.6 480.6 302.9 439.8 244.6" 
          />
          <motion.path 
            custom={5}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
          ...
          <motion.polygon 
            ...
            points="207.9 244.6 207.9 332 259.9 332 259.9 315.1 226.9 314.9 226.9 295.8 252.4 295.8 257 279.3 226.9 279.3 226.9 261.6 259.9 261.6 259.9 244.6" 
          />
          <motion.polygon 
            custom={7}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
            ...
            points="409 279.3 378.8 279.3 378.8 261.6 411.9 261.6 411.9 244.6 359.9 244.6 359.9 332 411.9 332 411.9 315.1 378.8 314.9 378.8 295.8 404.4 295.8" 
          />
          <motion.path 
            custom={8}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
            ...
            d="m451.7 222c3 3.2 6.7 5.6 11 7.3s9.3 2.6 14.8 2.6 10.5-0.8 14.8-2.5c4.4-1.7 8.1-4.1 11.1-7.2s5.4-6.9 7-11.4c1.7-4.5 2.5-9.5 2.5-14.9l0.3-54.3h-19.1l-0.3 53.2c0 5.9-1.4 10.5-4.2 13.9s-6.8 5.1-12.1 5c-5.3 0-9.3-1.7-12-5.2-2.7-3.4-4.1-8.1-4.1-14l0.3-53.1h-19.1l-0.3 54c0 5.5 0.8 10.5 2.4 15 1.7 4.6 4 8.4 7 11.6z" 
          />
          <motion.path 
            custom={9}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
          ...
          <motion.polygon 
            ...
            points="143.4 141.6 147.7 150.6 147.7 220.3 143.4 229.3 196.7 229.3 201.5 212.2 166.6 212.2 166.6 141.6" 
          />
          <motion.polygon 
            custom={11}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
            ...
            points="143.4 244.3 147.7 253.4 147.7 323 143.4 332.1 196.7 332.1 201.5 314.9 166.6 314.9 166.6 244.3" 
          />
          <motion.polygon 
            custom={12}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
            ...
            points="207.9 141.8 207.9 229.3 259.9 229.3 259.9 212.4 226.9 212.2 226.9 193 252.4 193 257 176.6 226.9 176.6 226.9 158.9 259.9 158.9 259.9 141.8" 
          />
          <motion.polygon 
            custom={13}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
            ...
            points="521.5 141.8 521.5 229.3 573.5 229.3 573.5 212.4 540.4 212.2 540.4 193 566 193 570.6 176.6 540.4 176.6 540.4 158.9 573.5 158.9 573.5 141.8" 
          />
          <motion.path 
            custom={14}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
            ...
            d="m285.3 229.3 6.6-17.1h35l6.8 17.1h19.7l-35.1-87.7h-26.9l5.6 11.4-31 76.3zm24.4-63.2 10.9 29.4h-22.3z" 
          />
          <motion.path 
            custom={15}
            stroke="#C89B3C" strokeWidth="1" fill="#C89B3C"
          ...
          <motion.path 
            ...
            d="m352.5 284.4h-43.5l-7.7 15.8h30.9c-1.2 5-3.9 9.1-8.1 12.2s-9.2 4.6-15.1 4.6c-2.6 0-5.1-0.4-7.5-1.1l-4.2 17.2c3.7 0.9 7.5 1.4 11.5 1.4 6.3 0 12.1-1 17.4-3.2s9.9-5.2 13.8-9 6.9-8.4 9.1-13.7c1.6-3.8 2.6-7.8 3.1-12 0.2-1.6 0.5-8.9 0.3-12.2z" 
          />
          
          {/* Blue Elements - Splash Icon / Flair */}
          <motion.path 
            custom={10}
            stroke="#32C8FF" strokeWidth="1" fill="#32C8FF"
            variants={{
              hidden: { ...draw.hidden, ...fill.hidden },
              visible: (i) => ({
                ...draw.visible(i),
          ...
          <motion.path 
            ...
            d="m276.5 396.1c-2.2 0.8-1.6 1.5-3.5 3.4-0.7 0.8-2.3 0.4-2.7 1.3-3.4 8-11.4 26-13.6 33.8-0.3 1 0.3 1.9 0.9 2.2 0 0 1.2-3.6 1.8-3.1 1 0.8 0 5.2 0.8 5.7 1.4 0.8 2.6 1.4 3.4-0.4 1-2.2 4.4-11.9 8.6-21.7 3.4-8.1 8-17.3 10.9-21.5 2.1-3-4.4-0.4-6.6 0.3" 
          />
          <motion.path 
            custom={15}
            stroke="#32C8FF" strokeWidth="1" fill="#32C8FF"
          ...
          <motion.path 
            ...
            d="m464.6 378c-1.2 1.2-2.3 4.3-3.9 5.5-0.9 0.6-3.8 1.7-4.2 2.6-2.7 7.1-9.9 27.1-10.2 29.7-0.1 1.1 0.4 1.4 1.2 1.7 1.8 0.8 2.7-1.2 4.2-0.5 0.8 0.4-0.1 2.5 0.3 3.2 0.6 1.1 1.2 0.3 1.9-1.9 1.8-5.9 6.7-20.6 9.1-26.6 2.3-5.7 4.2-10.3 5.8-14.2 0.5-1.3-3-0.7-4.2 0.5" 
          />
          <motion.path 
            custom={17}
            stroke="#32C8FF" strokeWidth="1" fill="#32C8FF"
            ...
            d="m616.6 349h-1.8v-1h4.8v1h-1.8v4.2h-1.1v-4.2zm4.2-1.1h1.2l1.8 2.8 1.8-2.8h1.2v5.2h-1.1v-3.5l-1.8 2.8h-0.1l-1.8-2.8v3.5h-1.1v-5.2" 
          />
        </g>
      </motion.svg>
    </div>
