...
export const AllyPanel: React.FC = () => {
  ...
  return (
    <Card className="h-full border-zinc-800 bg-zinc-950/50 flex flex-col overflow-hidden">
      <CardHeader className="p-3 border-b border-zinc-800 bg-zinc-900/40">
      ...
      <CardContent className="p-2 flex flex-col gap-1 overflow-y-auto custom-scrollbar">
        {ALL_ROLES.map((role) => {
            ...
            >
              ...
              <div className="flex flex-col min-w-0 flex-1">
                <div className="flex items-center justify-between gap-1">
                  ...
                  {!champion && isFocused && (
                    <Badge variant="outline" className="h-3 px-1 text-[7px] font-black border-blue-500/50 text-blue-500 uppercase bg-blue-500/5 anim-pulse">
                      Selecting
                    </Badge>
                  )}
                </div>
      ...
      {/* Analytics Footer */}
      <div className="mt-auto p-3 border-t border-zinc-800 bg-zinc-900/20 space-y-3">
