            ...
            {[...Array(5)].map((_, i) => {
                ...
                return (
                    <div key={i} className={cn(
                        "flex-1 rounded-md border overflow-hidden relative group transition-all duration-300",
        ...
        {(Object.keys(ROLE_LABELS) as Role[]).map((role) => {
          ...
          return (
            <div key={role} className="flex flex-col gap-1">
                <button 
                  onClick={() => setFocusedSlot(side, role)}
                  className={cn(
                ...
                {champion && bd && (
                    <div className="mx-2 p-2 bg-black/20 border-x border-b border-white/5 rounded-b-lg grid grid-cols-4 gap-2">
                        {isAlly ? (
                          ...
                          <>
                            <div className="flex flex-col items-center">
                                <span className="text-[7px] font-bold text-zinc-600 uppercase">Threat</span>
                                <span className="text-[10px] font-bold text-red-400">{Math.round(bd.breakdown.threat)}</span>
                            </div>
                            <div className="flex flex-col items-center border-x border-white/5">
                                <span className="text-[7px] font-bold text-zinc-600 uppercase">Counter</span>
                                <span className="text-[10px] font-bold text-orange-400">{Math.round(bd.breakdown.counter)}</span>
                            </div>
                            <div className="flex flex-col items-center border-r border-white/5">
                                <span className="text-[7px] font-bold text-zinc-600 uppercase">Base</span>
