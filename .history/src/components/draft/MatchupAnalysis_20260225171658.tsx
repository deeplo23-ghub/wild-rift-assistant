...
function TeamOverview({ grade, damage, grading, color, isEnemy, isSuperior }: any) {
    ...
    const themeColor = color === "blue" ? "text-blue-500/80" : "text-red-500/80";
    ...
    return (
        <div className={cn(
            ...
            <div className={cn(
                "absolute top-0 w-full h-0.5 opacity-30",
                    ...
                    <TooltipTrigger asChild>
                      <div className={cn(
                        ...
                        <span className={cn(
                            ...
                            isSuperior ? (color === "blue" ? "text-blue-400/90" : "text-red-400/90") : "text-white/80"
                        )}>
