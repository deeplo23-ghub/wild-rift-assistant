    ...
    <div className="flex flex-col gap-4 h-full">
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 min-w-0">
                    <div className="flex items-center gap-1.5 mb-0.5">
                       ...
                       <span className="text-[8px] font-black text-blue-500 capitalize tracking-widest leading-none">
                         {ROLE_LABELS[role]}
                       </span>
                    </div>
      ...
      <Card className="mt-2 border-white/5 bg-zinc-900/80 backdrop-blur-xl overflow-hidden flex-1 shadow-2xl">
        <div className="bg-blue-500/10 p-3 border-b border-blue-500/10">
            <h3 className="flex items-center gap-2 text-[10px] font-black capitalize tracking-widest text-blue-400">
        ...
        <CardContent className="p-4 space-y-4">
            ...
            <div className="p-3 bg-red-500/5 border border-red-500/10 rounded-lg">
                <p className="text-[9px] text-red-200/60 leading-relaxed italic">
                    <span className="font-black text-red-500 mr-1 capitalize">Warning:</span>
