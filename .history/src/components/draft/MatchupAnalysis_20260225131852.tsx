  ...
  return (
    <div className={cn(
      ...
      settings.disableTransparency ? "bg-zinc-950" : "bg-black/40 backdrop-blur-3xl"
        ...
        <div className="h-full flex flex-col pt-10 p-4 overflow-hidden">
            ...
            <div className="flex-1 min-h-0 relative group/scroll overflow-hidden">
                <div className="h-full overflow-y-auto pt-8 pr-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] flex flex-col gap-2 pb-8">
