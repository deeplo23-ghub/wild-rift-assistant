...
function TeamOverview({ grade, damage, grading, color, isEnemy, isSuperior }: any) {
    ...
    return (
        <div className={cn(
            "bg-black/20 p-4 rounded-xl border border-white/5 flex flex-col gap-3 shadow-xl relative",
            ...
            <div className={cn(
                ...
                isEnemy ? "flex-row-reverse" : "flex-row"
                 ...
                 <div className={cn(
                    ...
                    {/* Tooltip */}
                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2.5 py-1.5 bg-zinc-950/95 border border-white/10 rounded-lg text-[9.5px] font-bold text-zinc-100 whitespace-nowrap opacity-0 group-hover/grade:opacity-100 transition-all duration-200 pointer-events-none z-50 shadow-2xl backdrop-blur-md -translate-y-1 group-hover/grade:translate-y-0 text-center">
                        COMPOSITION GRADE
                        <div className="absolute bottom-full left-1/2 -translate-x-1/2 -mb-1 w-2 h-2 bg-zinc-950/95 border-l border-t border-white/10 rotate-45" />
                    </div>
                 </div>
                 ...
                 <div className={cn(
                    ...
                    {/* Tooltip */}
                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2.5 py-1.5 bg-zinc-950/95 border border-white/10 rounded-lg text-[9.5px] font-bold text-zinc-100 whitespace-nowrap opacity-0 group-hover/avg:opacity-100 transition-all duration-200 pointer-events-none z-50 shadow-2xl backdrop-blur-md -translate-y-1 group-hover/avg:translate-y-0 text-center">
                        AVERAGE POWER
                        <div className="absolute bottom-full left-1/2 -translate-x-1/2 -mb-1 w-2 h-2 bg-zinc-950/95 border-l border-t border-white/10 rotate-45" />
                    </div>
                 </div>
                 ...
                 <div className={cn(
                    ...
                    {/* Tooltip */}
                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2.5 py-1.5 bg-zinc-950/95 border border-white/10 rounded-lg text-[9.5px] font-bold text-zinc-100 whitespace-nowrap opacity-0 group-hover/total:opacity-100 transition-all duration-200 pointer-events-none z-50 shadow-2xl backdrop-blur-md -translate-y-1 group-hover/total:translate-y-0 text-center">
            ...
            <div className="w-full mt-auto relative">
                ...
                <div className="flex w-full mb-1.5 items-end">
                    <div style={{ width: `${damage.ad}%` }} className="flex justify-center shrink-0 overflow-visible relative group/ad">
                        ...
                        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 bg-zinc-950/95 border border-white/10 rounded-lg text-[9px] font-bold text-orange-400 whitespace-nowrap opacity-0 group-hover/ad:opacity-100 transition-all duration-200 pointer-events-none z-50 shadow-2xl -translate-y-1 group-hover/ad:translate-y-0">
                            PHYSICAL DAMAGE
                            <div className="absolute bottom-full left-1/2 -translate-x-1/2 -mb-1 w-2 h-2 bg-zinc-950/95 border-l border-t border-white/10 rotate-45" />
                        </div>
                    </div>
                    <div style={{ width: `${damage.ap}%` }} className="flex justify-center shrink-0 overflow-visible relative group/ap">
                        ...
                        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 bg-zinc-950/95 border border-white/10 rounded-lg text-[9px] font-bold text-sky-400 whitespace-nowrap opacity-0 group-hover/ap:opacity-100 transition-all duration-200 pointer-events-none z-50 shadow-2xl -translate-y-1 group-hover/ap:translate-y-0">
                            MAGIC DAMAGE
                            <div className="absolute bottom-full left-1/2 -translate-x-1/2 -mb-1 w-2 h-2 bg-zinc-950/95 border-l border-t border-white/10 rotate-45" />
                        </div>
                    </div>
                    <div style={{ width: `${damage.truePct}%` }} className="flex justify-center shrink-0 overflow-visible relative group/true">
                        ...
                        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 bg-zinc-950/95 border border-white/10 rounded-lg text-[9px] font-bold text-white whitespace-nowrap opacity-0 group-hover/true:opacity-100 transition-all duration-200 pointer-events-none z-50 shadow-2xl -translate-y-1 group-hover/true:translate-y-0">
                            TRUE DAMAGE
                            <div className="absolute bottom-full left-1/2 -translate-x-1/2 -mb-1 w-2 h-2 bg-zinc-950/95 border-l border-t border-white/10 rotate-45" />
                        </div>
                    </div>
