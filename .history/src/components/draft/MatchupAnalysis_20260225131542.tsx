...
// ------------------------------------------------------------------------------------------------ //
// Clinical Tooltip Wrapper - Ensures Portaling to avoid cutoff
// ------------------------------------------------------------------------------------------------ //
function ClinicalTooltip({ content, children, side = "top" }: { content: string, children: React.ReactNode, side?: "top" | "bottom" | "left" | "right" }) {
    return (
        <Tooltip>
            ...
            <TooltipContent 
                ...
                sideOffset={8}
                hideArrow={true}
                className="bg-zinc-950/95 border-white/10 text-zinc-100 text-[9.5px] font-bold px-2.5 py-1.5 backdrop-blur-md shadow-2xl z-[100]"
            >
                {content}
                {/* Arrow is handled by the UI component */}
            </TooltipContent>
        </Tooltip>
    );
}
                            ...
                            return (
                                  <div key={m.key} className="flex items-center gap-3 group h-8 px-1.5 hover:bg-white/[0.03] rounded transition-colors duration-200">
                                     ...
                                     <div className="w-24 flex flex-col items-center justify-center relative h-8 shrink-0">
                                         <ClinicalTooltip content={m.desc}>
                                             <div 
            ...
            <div className={cn(
                ...
                isEnemy ? "flex-row-reverse" : "flex-row"
                 ...
                 {/* Module 1: Rating Badge */}
                  <ClinicalTooltip content="COMPOSITION GRADE">
                    <div className={cn(
                        "flex items-center justify-center w-12 h-12 rounded-xl border shadow-2xl shrink-0 transition-all duration-500 relative group/grade cursor-help",
                 ...
                 {/* Module 2: Average Power */}
                  <ClinicalTooltip content="AVERAGE POWER">
                    <div className={cn(
                 ...
                 {/* Module 3: Total Power */}
                  <ClinicalTooltip content="TOTAL MECHANICAL POWER">
                    <div className={cn(
            ...
            <div className="w-full mt-auto relative">
                ...
                <div className="flex w-full mb-1.5 items-end">
                    <div style={{ width: `${damage.ad}%` }} className="flex justify-center shrink-0 overflow-visible relative">
                        <ClinicalTooltip content="PHYSICAL DAMAGE DISTRIBUTION">
                    ...
                    <div style={{ width: `${damage.ap}%` }} className="flex justify-center shrink-0 overflow-visible relative">
                        <ClinicalTooltip content="MAGIC DAMAGE DISTRIBUTION">
                            <div className="flex items-center gap-1.5 leading-none cursor-help">
                    ...
                    <div style={{ width: `${damage.truePct}%` }} className="flex justify-center shrink-0 overflow-visible relative">
                        <ClinicalTooltip content="PURE/TRUE DAMAGE SOURCE">
                            <div className="flex items-center gap-1.5 leading-none cursor-help">
