...
interface PickSlotProps {
  ...
  highlightType: "synergy" | "counter" | null;
  isStatHighlight: any;
  settings: DraftSettings;
  onSlotClick: () => void;
  onHoverChamp: (id: string | null) => void;
...
export const TeamPanel: React.FC<TeamPanelProps> = ({ side }) => {
  ...
  // Helpers
  const getHighlightType = (champion: Champion): "synergy" | "counter" | null => {
    if (!hoveredChamp) return null;
    
    const isSameSide = side === focusedSide;
