            ...
            <div className="w-full mt-auto pt-4 relative">
                ...
                <div className="flex w-full mb-1">
                    <div style={{ width: `${damage.ad}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.ad >= 12 && (
                            <span className="text-[10px] font-black text-orange-500 tabular-nums drop-shadow-[0_0_3px_rgba(0,0,0,0.5)]">
                                {damage.ad.toFixed(0)}%
                            </span>
                        )}
                    </div>
                    <div style={{ width: `${damage.ap}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.ap >= 12 && (
                            <span className="text-[10px] font-black text-sky-500 tabular-nums drop-shadow-[0_0_3px_rgba(0,0,0,0.5)]">
                                {damage.ap.toFixed(0)}%
                            </span>
                        )}
                    </div>
                    <div style={{ width: `${damage.truePct}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.truePct >= 12 && (
                            <span className="text-[10px] font-black text-white tabular-nums drop-shadow-[0_0_3px_rgba(0,0,0,0.5)]">
