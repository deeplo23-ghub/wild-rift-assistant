            ...
            return (
              <button
                ...
                <div className="relative w-full aspect-square shadow-md group-hover:shadow-lg rounded-lg">
                  ...
                  {/* Tooltip on hover */}
                  <div className={cn(
                    "absolute bottom-[calc(100%+8px)] left-1/2 -translate-x-1/2 p-3 border border-white/10 rounded-lg shadow-2xl transition-opacity z-50 pointer-events-none whitespace-nowrap min-w-[140px]",
