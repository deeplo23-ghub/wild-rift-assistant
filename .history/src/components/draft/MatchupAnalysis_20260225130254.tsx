                ...
                <div className="h-full overflow-y-auto pr-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] flex flex-col gap-2 pb-8">
                    ...
                    <div className="flex flex-col gap-1.5 bg-black/20 p-2.5 rounded-lg border border-white/5">
                        ...
                        {ENGINE_METRICS.map(m => {
                            ...
                            return (
                                  <div key={m.key} className="flex items-center gap-3 group h-7">
                                     ...
                                     <div className="w-24 flex flex-col items-center justify-center relative h-7 shrink-0">
                                         <Tooltip>
                                             <TooltipTrigger asChild>
                                                 <div 
                                                     className="flex items-center gap-1.5 text-[9.5px] font-bold transition-colors duration-300 justify-center text-zinc-500 cursor-help group-hover:text-zinc-300"
                                             ...
                                             <TooltipContent side="top" className="bg-zinc-900 border-white/10 text-white font-bold tracking-tight">
                                                 {m.desc}
                                             </TooltipContent>
                                         </Tooltip>
                                     </div>
        ...
        <div className={cn(
            ...
            <div className={cn(
                ...
                isEnemy ? "flex-row-reverse" : "flex-row"
                 ...
                 <div className={cn(
                    "flex items-center justify-center w-12 h-12 rounded-xl border shadow-2xl shrink-0 transition-all duration-500 overflow-hidden relative",
