        ...
        <div className="h-full flex flex-col p-4 overflow-hidden">
            ...
            <div className="flex flex-col gap-2 flex-1 min-h-0 overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                <div className="flex flex-col gap-1 bg-black/20 p-2.5 rounded-lg border border-white/5">
                    <div className="flex items-center justify-center text-[8px] uppercase font-black text-cyan-500 tracking-[0.2em] border-b border-white/5 pb-1.5 mb-1.5 opacity-60">
                        Statistics
                    </div>
                    {STAT_METRICS.filter(m => isStatsExpanded || IMPORTANT_METRICS.includes(m.key)).map(m => {
                        ...
                        return (
                             <div key={m.key} className="flex flex-col py-1.5 border-b border-white/[0.02] last:border-0 group">
                                 ...
                                 {!isStatsExpanded && (
                                     <div className="text-[8.5px] text-zinc-500 text-center leading-tight mt-1 opacity-70 font-medium italic">
                                         {m.desc}
                                     </div>
                                 )}
                             </div>
                    ...
                    <div className="flex justify-center mt-2">
                        <button 
                            ...
                            className="flex items-center gap-1.5 py-1 px-3 text-[9px] font-black text-zinc-500 hover:text-cyan-400 transition-all uppercase tracking-widest hover:bg-cyan-500/5 rounded-md"
                        >
                            {isStatsExpanded ? (
