        ...
        <CardContent className="p-4 space-y-4">
            ...
            <div className="space-y-3">
               <div className="space-y-1.5">
                   <div className="flex justify-between items-end text-[8px] font-black capitalize text-zinc-500">
                   ...
                   <div className="h-1.5 w-full bg-zinc-800/50 rounded-full overflow-hidden flex border border-white/5 shadow-inner">
                       <div className="h-full bg-gradient-to-r from-orange-600 to-orange-500 transition-all duration-1000" style={{ width: `${adPercent}%` }} />
                       <div className="h-full bg-gradient-to-r from-blue-500 to-blue-400 transition-all duration-1000" style={{ width: `${apPercent}%` }} />
                       <div className="h-full bg-gradient-to-r from-yellow-500 to-yellow-400 transition-all duration-1000" style={{ width: `${truePercent}%` }} />
                   </div>
               </div>
               <div className="space-y-1.5">
