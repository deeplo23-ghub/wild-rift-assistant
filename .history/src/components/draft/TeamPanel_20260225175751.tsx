...
export const TeamPanel: React.FC<TeamPanelProps> = ({ side }) => {
  ...
  const getHighlightType = (champion: Champion): "synergy" | "counter" | "weak" | null => {
    ...
    if (isSameSide) {
      // Same side: check synergy with the hovered champion
      ...
      // Opposing side: check if hovered champ counters this champion
      ...
      // Check if this champion counters the hovered champ (weakness)
