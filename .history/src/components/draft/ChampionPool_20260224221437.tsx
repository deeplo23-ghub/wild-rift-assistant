                ...
                <div className="relative w-full aspect-square shadow-md group-hover:shadow-lg rounded-lg">
                  <div className={cn(
                    ...
                    <ChampionIcon 
                      ...
                      className={cn("w-full h-full transform transition-transform duration-300 group-hover:scale-110", isUnavailable && "grayscale", isPicked && "opacity-30", isAnyBanned && "opacity-50")} 
                    />
                    {isAnyBanned && (
