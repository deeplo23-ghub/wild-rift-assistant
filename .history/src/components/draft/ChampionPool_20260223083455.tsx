              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col gap-5">
                    ...
                    {/* Breakdown Mini-Grid */}
                     {score && (
                       <div className="grid grid-cols-2 gap-x-6 gap-y-2 p-3 bg-black/20 rounded-xl border border-white/5">
                          <div className="flex justify-between items-center">
                            <span className="text-[9px] text-zinc-500 font-bold uppercase">Synergy</span>
                            <span className="text-[10px] font-bold text-emerald-400">+{Math.round(score.detailedScores.synergy)}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-[9px] text-zinc-500 font-bold uppercase">Counter</span>
                            <span className="text-[10px] font-bold text-orange-400">+{Math.round(score.detailedScores.counter)}</span>
                          </div>
                          <div className="flex justify-between items-center">
                             <span className="text-[9px] text-zinc-500 font-bold uppercase">Risk</span>
                             <span className="text-[10px] font-bold text-red-400">-{Math.round(score.detailedScores.risk)}</span>
                          </div>
                          <div className="flex justify-between items-center">
                             <span className="text-[9px] text-zinc-500 font-bold uppercase">Engine</span>
                             <span className="text-[10px] font-bold text-blue-400">{Math.round(score.detailedScores.base)}</span>
                          </div>
                       </div>
                     )}
