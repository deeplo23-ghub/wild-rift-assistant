      ...
      <CardContent className="p-[15px] flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2 mt-[2px] px-1 pb-0.5">
          ...
          <div className="flex gap-1 items-center overflow-x-auto scrollbar-none">
            ...
            {topSynergies.length > 0 && (topCounters.length > 0 || topWeaknesses.length > 0) && (
            ...
            {topCounters.length > 0 && topWeaknesses.length > 0 && (
              <div className="w-px h-2.5 bg-white/10 mx-0.5" />
            )}
  ...
  return (
    <div className="flex flex-col h-full min-h-0 gap-4 text-white font-sans selection:bg-blue-500/30">
      ...
      <ScrollArea className={cn(
        ...
        <div className={cn("grid gap-2 justify-center items-start", settings.gridDensity ? "grid-cols-13" : "grid-cols-10")}>
          {others.map((champion) => (
            <ChampionGridItem 
              key={champion.id}
              champion={champion}
