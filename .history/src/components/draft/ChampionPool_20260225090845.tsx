  ...
  return (
    <div className="flex flex-col h-full min-h-0 gap-4 text-white font-sans selection:bg-blue-500/30">
      ...
      <div className={cn(
        ...
        settings.disableTransparency ? "bg-zinc-900" : "bg-black/40 backdrop-blur-md"
      )}>
            ...
            return (
              <button
                ...
                <div className="relative w-full aspect-square shadow-md group-hover:shadow-lg rounded-lg">
                  ...
                  <div className={cn(
                    "absolute bottom-[calc(100%+8px)] left-1/2 -translate-x-1/2 p-3 border border-white/10 rounded-lg shadow-2xl transition-opacity z-50 pointer-events-none whitespace-nowrap min-w-[140px] flex flex-col items-center",
                    settings.disableAnimations ? "opacity-0 invisible group-hover:visible group-hover:opacity-100" : "opacity-0 group-hover:opacity-100",
                    settings.disableTransparency ? "bg-zinc-800" : "bg-black/40 backdrop-blur-xl"
                  )}>
