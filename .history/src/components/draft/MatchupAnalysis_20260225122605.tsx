        ...
        <div className="h-full flex flex-col p-4 overflow-hidden">
            ...
            <div className="flex flex-col gap-2 flex-1 min-h-0 overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                <div className="flex flex-col gap-1 bg-black/20 p-2.5 rounded-lg border border-white/5">
                    <div className="flex items-center justify-center text-[9px] uppercase font-black text-white tracking-[0.2em] border-b border-white/5 pb-1.5 mb-1.5">
                        Statistics
                    </div>
                    ...
                    <div className="flex justify-center mt-2">
                        <button 
                            ...
                            className="flex items-center gap-1.5 py-1 px-3 text-[9px] font-black text-zinc-500 hover:text-white transition-all uppercase tracking-widest hover:bg-white/5 rounded-md"
                        >
                            {isStatsExpanded ? (
