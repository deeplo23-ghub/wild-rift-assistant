          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="h-6 w-full flex rounded-full overflow-hidden border border-white/5 shadow-inner">
                <div style={{ width: `${adPct}%` }} className="bg-orange-500 h-full transition-all duration-700 ease-out" title={`AD: ${Math.round(adPct)}%`} />
                <div style={{ width: `${apPct}%` }} className="bg-blue-500 h-full transition-all duration-700 ease-out" title={`AP: ${Math.round(apPct)}%`} />
                <div style={{ width: `${truePct}%` }} className="bg-white h-full transition-all duration-700 ease-out" title={`True: ${Math.round(truePct)}%`} />
              </div>
