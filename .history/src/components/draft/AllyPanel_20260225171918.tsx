  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      <Card className="mt-2 border-white/5 bg-zinc-900/80 backdrop-blur-xl overflow-hidden flex-1 shadow-2xl">
        <div className="bg-red-500/10 p-3 border-b border-red-500/10">
            <h3 className="flex items-center gap-2 text-[10px] font-black capitalize tracking-widest text-red-400/80">
