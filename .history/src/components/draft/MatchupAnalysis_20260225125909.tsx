        ...
        <div className={cn(
            ...
            <div className={cn(
                ...
                isEnemy ? "flex-row-reverse" : "flex-row"
                 ...
                 <div className={cn(
                    "flex items-center justify-center w-12 h-12 rounded-xl border shadow-2xl shrink-0 transition-all duration-500",
                    gradeColor,
                    isS && !settings.disableAnimations && "animate-pulse",
