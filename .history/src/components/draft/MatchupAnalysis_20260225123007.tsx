                        ...
                        return (
                             <div key={m.key} className="flex items-center gap-3 group h-6">
                                 ...
                                 <div className="w-24 flex flex-col items-center justify-center relative h-6">
                                     <div className={cn("flex items-center gap-1 text-[8px] font-bold transition-colors duration-300 absolute inset-0 justify-center group-hover:opacity-0 pointer-events-none", iconColor)}>
            ...
            <div className="w-full mt-auto pt-5 relative">
                ...
                <div className="flex w-full mb-1.5 items-end">
                    <div style={{ width: `${damage.ad}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.ad >= 10 && (
                            <div className="flex items-center gap-1.5 px-1.5 py-0.5 rounded bg-orange-500/10 border border-orange-500/20 shadow-sm leading-none">
                                <span className="text-[7px] font-black text-orange-500/50">AD</span>
                    ...
                    <div style={{ width: `${damage.ap}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.ap >= 10 && (
                            <div className="flex items-center gap-1.5 px-1.5 py-0.5 rounded bg-sky-500/10 border border-sky-500/20 shadow-sm leading-none">
                                <span className="text-[7px] font-black text-sky-500/50">AP</span>
                                <span className="text-[9px] font-black text-sky-500 tabular-nums">
                                    {damage.ap.toFixed(0)}%
                                </span>
                            </div>
                        )}
                    ...
                    <div style={{ width: `${damage.truePct}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.truePct >= 10 && (
                            <div className="flex items-center gap-1.5 px-1.5 py-0.5 rounded bg-white/5 border border-white/10 shadow-sm leading-none">
                                <span className="text-[7px] font-black text-white/50">TRUE</span>
