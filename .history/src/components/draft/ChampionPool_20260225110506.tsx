...
const getDamageType = (profile: { ad: number; ap: number; true: number }) => {
  ...
  if (ad > 0.3 && ap > 0.3) return { 
    label: "HYBRID", 
    style: "bg-gradient-to-br from-orange-400 via-fuchsia-500 to-blue-500 border-transparent shadow-md antialiased", 
    textStyle: "text-black font-[900] tracking-tighter" 
  };
