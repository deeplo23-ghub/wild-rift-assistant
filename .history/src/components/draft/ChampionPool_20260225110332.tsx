...
const getDamageType = (profile: { ad: number; ap: number; true: number }) => {
  ...
  if (t >= 0.1) return { label: "TRUE", style: "bg-zinc-100 text-black border-transparent", textStyle: "" };
  ...
  if (ap > 0.6) return { label: "AP", style: "bg-blue-600 text-black border-transparent", textStyle: "" };
  return { label: "AD", style: "bg-orange-600 text-black border-transparent", textStyle: "" };
};
