        ...
        <div className={cn(
            ...
            <div className={cn(
                ...
                isEnemy ? "flex-row-reverse" : "flex-row"
                 ...
                 <div className={cn(
                    "flex items-center justify-center w-12 h-12 rounded-xl border border-white/5 shadow-2xl shrink-0",
                 ...
                 <div className={cn(
                    "flex flex-col items-center justify-center px-3 h-12 rounded-xl border border-white/5 shadow-2xl grow min-w-[60px]",
                    settings.disableTransparency ? "bg-zinc-900" : "bg-black/25 backdrop-blur-md"
                 )}>
                    <span className="text-[7px] font-black text-zinc-500 tracking-[0.2em] uppercase opacity-70 leading-none mb-1">AVG</span>
                    <span className={cn(
                 ...
                 <div className={cn(
                    "flex items-center justify-center px-4 h-12 rounded-xl border border-white/10 shadow-2xl shrink-0",
                    settings.disableTransparency ? "bg-zinc-900" : "bg-white/[0.03] backdrop-blur-2xl"
                 )}>
                    <span className="text-2xl font-black text-white tabular-nums tracking-tighter drop-shadow-xl">
