            ...
            <div className="flex flex-col gap-2 flex-1 min-h-0">
                <div className="flex flex-col gap-1 bg-black/20 p-2.5 rounded-lg border border-white/5">
                    <div className="flex items-center justify-between border-b border-white/5 pb-1.5 mb-1.5 ">
                        <div className="flex items-center gap-1.5 text-[8px] uppercase font-black text-cyan-500 tracking-widest opacity-70">
                            <TrendingUp className="w-2.5 h-2.5" /> Direct Engine Parametrics
                        </div>
                        <button 
                            onClick={() => setIsStatsExpanded(!isStatsExpanded)}
                            className="flex items-center gap-1 text-[8px] font-bold text-zinc-500 hover:text-cyan-400 transition-colors uppercase tracking-widest"
                        >
                            {isStatsExpanded ? (
                                <><ChevronUp className="w-3 h-3" /> Show Basic</>
                            ) : (
                                <><ChevronDown className="w-3 h-3" /> Show All {STAT_METRICS.length} Breakdown</>
                            )}
                        </button>
                    </div>
