    ...
    return (
        <div className={cn(
            ...
            <div className={cn("w-full flex flex-col gap-2", isEnemy && "items-end")}>
                <div className="flex items-center gap-1.5 text-[8px] font-black text-zinc-500 tracking-[0.2em] opacity-40">
            ...
            <div className="w-full mt-auto pt-5 relative">
                ...
                <div className="flex w-full mb-1.5 items-end">
                    <div style={{ width: `${damage.ad}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.ad >= 10 && (
                            <div className="flex items-center gap-1.5 px-2 py-1 rounded bg-orange-500/15 border border-orange-500/30 shadow-sm leading-none">
                                <span className="text-[8px] font-black text-orange-400 tracking-wider">AD</span>
                    ...
                    <div style={{ width: `${damage.ap}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.ap >= 10 && (
                            <div className="flex items-center gap-1.5 px-2 py-1 rounded bg-sky-500/15 border border-sky-500/30 shadow-sm leading-none">
                                <span className="text-[8px] font-black text-sky-400 tracking-wider">AP</span>
                                <span className="text-[9px] font-black text-white tabular-nums">
                                    {damage.ap.toFixed(0)}%
                                </span>
                            </div>
                    ...
                    <div style={{ width: `${damage.truePct}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.truePct >= 10 && (
                            <div className="flex items-center gap-1.5 px-2 py-1 rounded bg-white/5 border border-white/20 shadow-sm leading-none">
                                <span className="text-[8px] font-black text-white/70 tracking-wider">TRUE</span>
                                <span className="text-[9px] font-black text-white tabular-nums">
