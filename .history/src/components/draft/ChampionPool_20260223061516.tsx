    ...
    <div className="flex flex-col h-full gap-4">
      <Card className="flex flex-col border-white/10 bg-zinc-900/40 backdrop-blur-xl shadow-2xl overflow-hidden">
        ...
        <ScrollArea className="flex-1 px-6 pb-6 h-[400px]">
          <div className="champion-grid grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-3">
            {filteredChampions.map((champion) => {
              ...
              return (
                <button
                  ...
                  className={`champion-card group relative flex flex-col items-center gap-2 p-1.5 rounded-xl transition-all duration-300 active:scale-95 ${
