...
function TeamOverview({ grade, damage, color, isEnemy }: any) {
    ...
    return (
        <div className={cn(
            ...
            {/* Refined Power Scorecard - Absolute Separation */}
            <div className={cn(
                "flex items-center gap-5 rounded-xl px-4 py-2 border border-white/5 shadow-2xl relative group/card", 
                ...
                settings.disableTransparency ? "bg-zinc-900" : "bg-black/30 backdrop-blur-md"
                 ...
                 {/* Average Area */}
                 <div className={cn("flex flex-col -gap-1 min-w-[45px]", isEnemy ? "items-end" : "items-start")}>
                    <span className="text-[7px] font-black text-zinc-500 tracking-[0.2em] uppercase opacity-70">AVG</span>
                    <span className={cn(
