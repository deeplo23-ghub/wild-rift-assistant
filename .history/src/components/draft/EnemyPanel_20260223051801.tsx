          ...
          return (
            ...
            >
              ...
              <div className="flex-1 overflow-hidden flex flex-col items-end">
                <span className={`text-[10px] font-bold uppercase tracking-widest leading-none block mb-1 truncate text-right ${isActive ? "text-red-300" : "text-red-400"}`}>
                  {ROLE_LABELS[role]}
                </span>
                <span className={`text-sm font-black truncate block text-right ${slot.championId ? "text-slate-100" : "text-slate-500 italic font-medium"}`}>
