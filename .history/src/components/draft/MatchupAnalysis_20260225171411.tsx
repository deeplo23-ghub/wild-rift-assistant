            ...
            <div className="flex flex-col gap-2 mb-4 bg-black/20 p-3 rounded-xl border border-white/5 shadow-inner">
                <div className="flex justify-between items-end px-1">
                    <div className="flex items-center gap-2">
                        <span className="text-xs font-black text-blue-400 tracking-wider">ALLY</span>
                        <span className="text-lg font-black text-white leading-none">{allyWinProb.toFixed(1)}%</span>
                    </div>
                    <span className="text-[10px] font-black text-white/40 tracking-widest mb-0.5">EST. WIN PROBABILITY</span>
                    <div className="flex items-center gap-2">
                        <span className="text-lg font-black text-white leading-none">{enemyWinProb.toFixed(1)}%</span>
                        <span className="text-xs font-black text-red-400 tracking-wider">ENEMY</span>
                    </div>
                </div>
                <div className="h-2.5 w-full bg-zinc-950 rounded-full flex shadow-inner border border-white/10 overflow-hidden">
                    <div className="h-full bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.3)] transition-all duration-1000 relative" style={{ width: `${allyWinProb}%` }} />
                    <div className="h-full bg-red-500 shadow-[0_0_10px_rgba(239,68,68,0.3)] transition-all duration-1000 relative" style={{ width: `${enemyWinProb}%` }} />
                </div>
            </div>
        ...
        <div className={cn(
            ...
            <div className={cn(
                ...
                isEnemy ? "flex-row-reverse" : "flex-row"
                  ...
                  <Tooltip delayDuration={0}>
                    <TooltipTrigger asChild>
                      <div className={cn(
                        "flex items-center justify-center w-12 h-12 rounded-xl border shadow-2xl shrink-0 transition-all duration-500 overflow-hidden relative group/grade cursor-help",
                  ...
                  <Tooltip delayDuration={0}>
                    <TooltipTrigger asChild>
                      <div className={cn(
                        "flex flex-col items-center justify-center px-3 h-12 rounded-xl border border-white/5 shadow-2xl grow min-w-[60px] relative group/avg cursor-help",
                  ...
                  <Tooltip delayDuration={0}>
                    <TooltipTrigger asChild>
                      <div className={cn(
                        "flex items-center justify-center px-4 h-12 rounded-xl border border-white/10 shadow-2xl shrink-0 relative group/total cursor-help",
            ...
            <div className="w-full mt-auto relative">
                ...
                <div className="flex w-full mb-1.5 items-end">
                    <div style={{ width: `${damage.ad}%` }} className="flex justify-center shrink-0 overflow-visible relative">
                        {damage.ad >= 10 && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <div className="flex items-center gap-1.5 leading-none cursor-help group/ad">
                                        <span className="text-[12px] font-black text-orange-400 tracking-wider transition-colors group-hover/ad:text-orange-300">AD</span>
                                ...
                                <TooltipContent 
                                    side="top" 
                                    hideArrow={true}
                                    className="px-2 py-1 bg-zinc-950/95 border border-white/10 rounded-lg text-[9px] font-bold text-orange-400 whitespace-nowrap shadow-2xl animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 translate-y-[-4px]"
                                >
                                    PHYSICAL DAMAGE
                                    <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-1 w-2 h-2 bg-zinc-950/95 border-r border-b border-white/10 rotate-45" />
                                </TooltipContent>
                    ...
                    <div style={{ width: `${damage.ap}%` }} className="flex justify-center shrink-0 overflow-visible relative">
                        {damage.ap >= 10 && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <div className="flex items-center gap-1.5 leading-none cursor-help group/ap">
                                        <span className="text-[12px] font-black text-sky-400 tracking-wider transition-colors group-hover/ap:text-sky-300">AP</span>
                                        <span className="text-[12px] font-black text-white tabular-nums">
                                            {damage.ap.toFixed(0)}%
                                        </span>
                                    </div>
                                ...
                                <TooltipContent 
                                    side="top" 
                                    hideArrow={true}
                                    className="px-2 py-1 bg-zinc-950/95 border border-white/10 rounded-lg text-[9px] font-bold text-sky-400 whitespace-nowrap shadow-2xl animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 translate-y-[-4px]"
                                >
                                    MAGIC DAMAGE
                                    <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-1 w-2 h-2 bg-zinc-950/95 border-r border-b border-white/10 rotate-45" />
                                </TooltipContent>
                    ...
                    <div style={{ width: `${damage.truePct}%` }} className="flex justify-center shrink-0 overflow-visible relative">
                        {damage.truePct >= 10 && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <div className="flex items-center gap-1.5 leading-none cursor-help group/true">
                                        <span className="text-[12px] font-black text-white/70 tracking-wider transition-colors group-hover/true:text-white">TRUE</span>
                                        <span className="text-[12px] font-black text-white tabular-nums">
                                ...
                                <TooltipContent 
                                    side="top" 
                                    hideArrow={true}
                                    className="px-2 py-1 bg-zinc-950/95 border border-white/10 rounded-lg text-[9px] font-bold text-white whitespace-nowrap shadow-2xl animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 translate-y-[-4px]"
                                >
                                    TRUE DAMAGE
                                    <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-1 w-2 h-2 bg-zinc-950/95 border-r border-b border-white/10 rotate-45" />
                                </TooltipContent>
