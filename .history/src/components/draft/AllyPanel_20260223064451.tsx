...
import { Users, AlertTriangle, X, Lock } from "lucide-react";
  ...
  return (
    <Card className="h-full border-gray-700/30 bg-gray-800/50 flex flex-col overflow-hidden rounded-xl shadow-sm">
      <CardHeader className="p-4 border-b border-gray-700/30 bg-gray-900/40 shrink-0">
        <CardTitle className="flex items-center justify-between text-lg font-semibold tracking-wide text-zinc-300">
        ...
        {ALL_ROLES.map((role) => {
          ...
          return (
            <button 
              ...
              className={cn(
                "group flex items-center gap-3 p-2 rounded-lg border transition-all text-left",
                isFocused 
            ...
            >
              ...
              <div className="flex flex-col min-w-0 flex-1">
                <div className="flex items-center justify-between gap-1">
                  ...
                  {!champion && isFocused && (
                    <Badge variant="outline" className="h-4 px-1.5 text-[10px] font-semibold border-blue-500/50 text-blue-500 uppercase bg-blue-500/5 animate-pulse rounded-md">
                      Selecting
                    </Badge>
                  )}
                </div>
              ...
              {champion && (
                <div className="flex items-center gap-2 shrink-0 pr-1">
                  <div className="flex flex-col items-end">
                    ...
                    <span className="text-[10px] text-zinc-600 font-medium uppercase mt-0.5">Winrate</span>
                  </div>
                </div>
              )}
            </button>
      ...
      <div className="mt-auto p-4 border-t border-gray-700/30 bg-gray-900/40 gap-4 flex flex-col shrink-0">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-xs font-normal uppercase tracking-wide text-zinc-500">
