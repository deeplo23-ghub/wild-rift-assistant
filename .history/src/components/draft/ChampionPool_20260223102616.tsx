          ...
          {others.map((champion) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ fontFamily: '"Space Grotesk", "Space Grotesk Fallback", sans-serif' }} className="text-[11px] leading-[17px] font-[700] text-white capitalize truncate w-full text-center">
                  {champion.name}
                </span>
              </button>
            );
