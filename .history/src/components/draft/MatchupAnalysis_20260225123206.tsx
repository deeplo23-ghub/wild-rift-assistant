                        ...
                        return (
                              <div key={m.key} className="flex items-center gap-3 group h-7">
                                 ...
                                 <div className="w-24 flex flex-col items-center justify-center relative h-7">
                                     <div className={cn("flex items-center gap-1.5 text-[9.5px] font-bold transition-colors duration-300 absolute inset-0 justify-center group-hover:opacity-0 pointer-events-none", iconColor)}>
                                         <m.icon className="w-3 h-3" /> {m.label}
                                     </div>
                                     <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                                         <span className="text-[9px] text-zinc-400 font-medium italic text-center w-full whitespace-nowrap overflow-hidden text-ellipsis">{m.desc}</span>
                                     </div>
                                 </div>
