            ...
            <div className="w-full mt-auto pt-5 relative">
                ...
                <div className="flex w-full mb-1.5 items-end">
                    <div style={{ width: `${damage.ad}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.ad >= 10 && (
                            <div className="flex flex-col items-center gap-0.5">
                                <span className="text-[7px] font-black text-orange-500/40 leading-none">AD</span>
                                <div className="px-1.5 py-0.5 rounded bg-orange-500/10 border border-orange-500/20 shadow-sm leading-none">
                    ...
                    <div style={{ width: `${damage.ap}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.ap >= 10 && (
                            <div className="flex flex-col items-center gap-0.5">
                                <span className="text-[7px] font-black text-sky-500/40 leading-none">AP</span>
                                <div className="px-1.5 py-0.5 rounded bg-sky-500/10 border border-sky-500/20 shadow-sm leading-none">
                    ...
                    <div style={{ width: `${damage.truePct}%` }} className="flex justify-center shrink-0 overflow-visible">
                        {damage.truePct >= 10 && (
                            <div className="flex flex-col items-center gap-0.5">
                                <span className="text-[7px] font-black text-white/40 leading-none">True</span>
                                <div className="px-1.5 py-0.5 rounded bg-white/5 border border-white/10 shadow-sm leading-none">
