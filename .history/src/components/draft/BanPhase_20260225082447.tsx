...
export function BanPhase({ champions }: BanPhaseProps) {
  ...
  return (
    <motion.div 
      initial={settings.disableAnimations ? false : { opacity: 0, y: -20 }}
      animate={settings.disableAnimations ? false : { opacity: 1, y: 0 }}
      exit={settings.disableAnimations ? false : { opacity: 0, y: -20 }}
