    ...
    <Card className="h-full border-gray-800 bg-gray-900 flex flex-col overflow-hidden rounded-none shadow-none">
            ...
            return (
              <div 
                ...
                className={cn(
                  ...
                  champ ? "border-gray-700" : "border-gray-800"
                )}
              >
                {champ ? (
                   <>
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col min-w-0 flex-1">
                ...
                {/* Damage Profile Bar for Picked Champ */}
                {champion && (
                    <div className="h-1 w-full flex bg-gray-950 mt-1 mt-auto">
      ...
      <div className="mt-auto p-3 border-t border-gray-800 bg-gray-950/40 flex flex-col gap-3 shrink-0 rounded-none">
        {missingRoles.length > 0 && (
          <div className="flex items-center gap-2 px-2 py-1 border border-gray-800 text-gray-500">
        ...
        <div className="space-y-1.5 font-medium">
          ...
          <div className="h-2 w-full bg-gray-950 border border-gray-800 flex">
