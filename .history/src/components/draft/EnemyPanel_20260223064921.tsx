    ...
    <Card className="h-full border-gray-800 bg-gray-900 flex flex-col overflow-hidden rounded-none shadow-none">
      ...
      <div className="mt-auto p-2 border-t border-gray-800 bg-gray-950/20 flex flex-col gap-2 shrink-0 rounded-none">
        {missingRoles.length > 0 && (
          <div className="flex flex-row-reverse items-center gap-2 px-1 py-0.5 border border-gray-800 bg-gray-900">
        ...
        <div className="space-y-1">
          <div className="flex flex-row-reverse items-center justify-between text-xs font-medium text-gray-500 uppercase">
          ...
          <div className="h-1.5 w-full bg-gray-950 rounded-none overflow-hidden flex flex-row-reverse border border-gray-800">
