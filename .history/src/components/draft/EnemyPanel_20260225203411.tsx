        ...
        <CardContent className="p-4 space-y-4">
            ...
            <div className="space-y-3">
               <div className="space-y-1.5">
                   <div className="flex justify-between items-end text-[8px] font-black capitalize text-zinc-500 flex-row-reverse">
                       <span className="flex gap-2 flex-row-reverse">
                           <span className="text-orange-500/80">AD {Math.round(adPercent)}%</span>
                           <span className="text-blue-400/80">AP {Math.round(apPercent)}%</span>
                           {truePercent > 2 && <span className="text-yellow-500/80">True {Math.round(truePercent)}%</span>}
                       </span>
                       <span className="tracking-widest opacity-60">DAMAGE PROFILE</span>
                   </div>
                   <div className="h-1.5 w-full bg-zinc-800/50 rounded-full overflow-hidden flex flex-row-reverse border border-white/5 shadow-inner">
                       <div className="h-full bg-gradient-to-l from-orange-600 to-orange-500 transition-all duration-1000" style={{ width: `${adPercent}%` }} />
                       <div className="h-full bg-gradient-to-l from-blue-500 to-blue-400 transition-all duration-1000" style={{ width: `${apPercent}%` }} />
                       <div className="h-full bg-gradient-to-l from-yellow-500 to-yellow-400 transition-all duration-1000" style={{ width: `${truePercent}%` }} />
                   </div>
               </div>
               <div className="space-y-1.5">
