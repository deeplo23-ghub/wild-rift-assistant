...
export function BanPhase({ champions }: BanPhaseProps) {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl rounded-2xl border border-red-500/20 bg-zinc-900/90 p-6 shadow-2xl backdrop-blur-xl">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xs font-black uppercase tracking-widest text-blue-500/70 ml-1">Ally Bans</h3>
              ...
              {[...Array(5)].map((_, i) => {
                ...
                return (
                  <div 
                    ...
                    className={cn(
                      "group relative h-16 w-16 rounded-xl border-2 transition-all cursor-pointer overflow-hidden",
                      champ 
          ...
          {/* Enemy Bans */}
          <div className="space-y-4">
            <h3 className="text-xs font-black uppercase tracking-widest text-red-500/70 ml-1">Enemy Bans</h3>
            <div className="flex gap-2">
              {[...Array(5)].map((_, i) => {
