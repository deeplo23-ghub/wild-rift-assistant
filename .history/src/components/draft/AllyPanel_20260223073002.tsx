    ...
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-black uppercase tracking-tighter text-white font-sans">Ally Team</h2>
        </div>
            ...
            {[...Array(5)].map((_, i) => {
                ...
                return (
                    <div key={i} className="flex-1 rounded border border-white/5 bg-black/40 overflow-hidden relative group">
                        ...
                        {champ && (
                           <div className="absolute inset-x-0 bottom-0 py-0.5 bg-red-500/80 text-[6px] font-black text-center text-white uppercase">Banned</div>
                        )}
                    </div>
                );
            })}
                ...
                >
                  <div className="w-10 h-10 rounded-md bg-zinc-800 border border-white/5 flex items-center justify-center overflow-hidden shrink-0">
                    {champion ? (
                      ...
                      <div className={cn("w-3 h-3 rounded-full border", isFocused ? "bg-blue-500 border-blue-400 animate-pulse" : "bg-zinc-700 border-zinc-600")} />
                    )}
                  </div>
                  
                  <div className="flex flex-col flex-1 min-w-0">
                    <span className="text-[8px] font-black text-blue-500 uppercase tracking-widest leading-none mb-0.5">
                      {ROLE_LABELS[role]}
                    </span>
                ...
                {champion && bd && (
                    <div className="mx-2 p-2 bg-black/20 border-x border-b border-white/5 rounded-b-lg grid grid-cols-4 gap-2">
                        <div className="flex flex-col items-center">
                            <span className="text-[7px] font-black text-zinc-600 uppercase">Syn</span>
                            <span className="text-[10px] font-bold text-blue-400">{Math.round(bd.breakdown.synergy)}</span>
                        </div>
                        <div className="flex flex-col items-center border-x border-white/5">
                            <span className="text-[7px] font-black text-zinc-600 uppercase">Comp</span>
                        ...
                        <div className="flex flex-col items-center">
                            <span className="text-[7px] font-black text-zinc-600 uppercase">Risk</span>
      ...
      <Card className="mt-2 border-white/5 bg-zinc-900/80 backdrop-blur-xl overflow-hidden flex-1 shadow-2xl">
        <div className="bg-blue-500/10 p-3 border-b border-blue-500/10">
            <h3 className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-blue-400">
        ...
        <CardContent className="p-4 space-y-4">
            ...
            <div className="space-y-3">
               <div className="space-y-1.5">
                   ...
                   <div className="h-1 w-full bg-zinc-800 rounded-full overflow-hidden">
                       <div className="h-full bg-blue-500 transition-all duration-1000" style={{ width: `${avgDamage * 10}%` }} />
                   </div>
               </div>
               <div className="space-y-1.5">
                   <div className="flex justify-between text-[8px] font-black uppercase text-zinc-500">
            ...
            <div className="grid grid-cols-2 gap-2">
                <div className="p-2 bg-black/20 rounded border border-white/5 flex flex-col gap-1">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[8px] font-black text-zinc-500 uppercase">Synergy</span>
                    </div>
                ...
                <div className="p-2 bg-black/20 rounded border border-white/5 flex flex-col gap-1">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[8px] font-black text-zinc-500 uppercase">Balance</span>
                    </div>
                ...
                <div className="p-2 bg-black/20 rounded border border-white/5 flex flex-col gap-1">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[8px] font-black text-zinc-500 uppercase">Risk Level</span>
                    </div>
                ...
                <div className="p-2 bg-black/20 rounded border border-white/5 flex flex-col gap-1">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[8px] font-black text-zinc-500 uppercase">Scaling</span>
                    </div>
            ...
            <div className="p-3 bg-red-500/5 border border-red-500/10 rounded-lg">
                <p className="text-[9px] text-red-200/60 leading-relaxed italic">
                    <span className="font-black text-red-500 mr-1 uppercase">Warning:</span>
