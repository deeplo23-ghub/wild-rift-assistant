          ...
          <div className="flex items-center gap-2 flex-1">
            <div className="relative flex-1 max-w-md">
              ...
              <Input
                ...
                className="pl-8 h-6 py-0 leading-[24px] bg-black/40 border-white/10 text-[10px] focus:ring-1 focus:ring-blue-500/50"
              />
            </div>
          </div>
          ...
          {top3.map((champion, idx) => {
            ...
            return (
              <Card 
                ...
                className={cn(
                  "relative border transition-all cursor-pointer group overflow-hidden bg-zinc-900 shadow-xl p-0 gap-0",
          ...
          {others.map((champion) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative w-full h-auto aspect-square transition-all active:scale-95 group rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50",
                  isUnavailable ? (isPicked ? "opacity-20 grayscale cursor-not-allowed" : "cursor-not-allowed") : "hover:scale-105 shadow-md hover:shadow-lg"
                )}
              >
                <div className={cn(
