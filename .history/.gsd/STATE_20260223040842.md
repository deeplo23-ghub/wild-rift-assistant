...
- Implement basic scoring utilities (base, counter, synergy, composition, threat, flexibility, risk).
- Impelement stage detection and weight combinations.
- Impelement explanation generator.
- Setup Vitest and run testing scenarios.
- Dev mock-draft script to verify.
