...
export interface Champion {
  ...
  /** Instant kill potential (0–10) */
  readonly burstScore: number;
  /** Combat distance and reach (0–10) */
  readonly rangeScore: number;
  /** Healing and combat longevity (0–10) */
  readonly sustainScore: number;
  /** 5v5 utility and coordination (0–10) */
  readonly teamfightScore: number;
  /** Monster and structure damage (0–10) */
