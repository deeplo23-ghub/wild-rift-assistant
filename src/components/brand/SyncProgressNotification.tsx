          ...
          <div className="flex items-center shrink-0 gap-3">
            ...
            {isActive ? (
              <button 
                ...
                className="p-1 rounded-full text-zinc-500 hover:text-red-400 hover:bg-red-500/10 transition-all group"
                title={settings.showTooltips ? "Cancel Sync" : undefined}
              >
              ...
              <button 
                onClick={onClose}
                className="p-1 rounded-full text-zinc-500 hover:text-white hover:bg-white/10 transition-all"
                title={settings.showTooltips ? "Dismiss" : undefined}
              >
                <X className="w-4 h-4" />
              </button>
            )}
